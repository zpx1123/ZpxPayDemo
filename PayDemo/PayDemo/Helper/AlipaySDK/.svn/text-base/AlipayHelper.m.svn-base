...
- (void)alipay:(Product *)product partner:(NSString *)_partner  seller:(NSString *)_seller  privateKey:(NSString *)_privateKey  block:(AlipayResult)block
{
...
//    NSString *privateKey = AlipayRSA_PRIVATE;
    ...
    NSString *partner = _partner;
    NSString *seller = _seller;
...
//        [alert show];
    ...
    order.service = AlipayRSA_ALIPAY_PUBLIC;
    order.paymentType = @"1";
